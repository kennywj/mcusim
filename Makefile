...
#
LIBS = -lshell -lapp -lesp8266 -lsys -llwip -lmbedtls -lfreertos -lfatfs -lpthread -lcoremark -lnn -lm
...
SUBDIRS = app sys shell FreeRTOS_Posix fatfs lwip_port esp8266 mbedtls-2.6.0/port kilo coremark_port nn
